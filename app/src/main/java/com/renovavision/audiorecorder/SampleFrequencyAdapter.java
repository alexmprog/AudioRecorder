...
public class SampleFrequencyAdapter extends BaseAdapter {
    ...
    @NonNull
    private SampleFrequency[] sampleFrequencies;

    public SampleFrequencyAdapter(@NonNull Context context, @NonNull SampleFrequency[] sampleFrequencies) {
    ...
    @Override
    public int getCount() {
        return sampleFrequencies.length;
    }

    @Override
    public SampleFrequency getItem(int position) {
        return sampleFrequencies[position];
    }
    ...
    private String getTitle(int position) {
        return position >= 0 && position < sampleFrequencies.length ? sampleFrequencies[position].getText() : "";
    }
}
